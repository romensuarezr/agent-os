...
| :--- | :--- | :---: | :---: | :--- | :---: |
| T-035 | Auditoría no destructiva de capacidad de disco y exposición de puertos en `oracle` | M | ⬜ Pendiente | Solo lectura; gate humano previo para ejecución de comandos | — |
